...
SinglePop = pop.Binaries(Nbin, model='sana_eccM&DS', single_pop=True, mass_ranges=[10.,150.], alphas=[-2.3]) # available: sana12 / sana_eccm&ds
...
#binSanaMDS.save_sevn_input('SEVNInputSingleMDS_Z', tstart='zams' ,tend='end', dtout='end')
SinglePop.save_sevn_input('SEVNInputSingleMDS_Z',tend='end', dtout='end')
