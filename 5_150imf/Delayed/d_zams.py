...
# ---------------------------BSE---------------------------------------------------------
# Load file
dt = dd.read_csv("d_sevn_output/output_*.csv")
...
# Load evolved file
dte = dd.read_csv("d_sevn_output/evolved_*.dat", sep='\s+')
# Give a look to the columns
print(dte.columns)
...
idx_t0 = (dt.RemnantType_0==6)
idx_t1 = (dt.RemnantType_1==6)

AllAllbh = dd.concat([dt[idx_t0].Mass_0,dt[idx_t1].Mass_1])
...
#Load file
Sdt=dd.read_csv("SSEd_sevn_output/output_*.csv")
#Give a look to the columns
print(Sdt.columns)
#Consider only the final states
...
#Load evolved file
Sdte=dd.read_csv("SSEd_sevn_output/evolved_*.dat",sep='\s+')
#Give a look to the columns
print(Sdte.columns)
...
plt.scatter(S_AllBHzams,S_AllBH,c='r',zorder=4,marker='d',s=2,label="SSE")
